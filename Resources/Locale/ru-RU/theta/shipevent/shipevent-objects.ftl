...
ent-TurretAmmoContainerBluespace = контейнер для боеприпасов (блюспейс)
    ...
    .suffix = { "ShipEvent" }
ent-BluespaceCatapultShipEvent = блюспейс катапульта
    .desc = { "Скрещение древнего орудия войны и современной науки. Используется для телепортации груза в радиусе вокруг корабля." }
    .suffix = { "ShipEvent" }
    
    
## Guns

ent-ShipEventRocketCannon = ракетная турель
    .desc = { "Турель стреляющая, вот сюрприз, ракетами." }
    .suffix = { "ShipEvent" }
ent-ShipEventShotgunCannon = турель-дробовик
    .desc = { "Большооой дробовик, способный превратить человека в кашу." }
    .suffix = { "ShipEvent" }

    
## Ammo

ent-ShellShotgunSlugShipEvent = ружейный патрон
    .desc = { "Патрон для дробовика нелепого калибра, с очень массивной дробью." }
    .suffix = { "ShipEvent" }
