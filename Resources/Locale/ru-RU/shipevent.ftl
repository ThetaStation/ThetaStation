...
shipevent-remove-dead = смерти всего её состава
shipevent-remove-tech = уничтожения жизненно важных компонентов её корабля
...
shipevent-teamview-heading2 = Название команды - Название корабля - Кол-во живых членов
