...
game-ticker-start-round-invalid-map = Выбранная карта { $map } не подходит для игрового режима { $mode }. Режим может принудительно выбрать подходящую карту (или нет).
