...
public sealed partial class ContentAudioSystem
{
    ...
    private void AmbienceCVarChanged(float obj)
    {
        ...
        {
            _ambientMusicStream.Volume = _musicProto.Sound.Params.Volume!.Value + _volumeSlider;
        }
    }
    ...
    private void UpdateAmbientMusic()
    {
        ...
        var strim = _audio.PlayGlobal(
            ...
            Filter.Local(),
            false,
            AudioParams.Default.WithVolume(_musicProto.Sound.Params.Volume!.Value + _volumeSlider));
