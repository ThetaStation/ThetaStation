...
public sealed partial class ModularRadarShuttleConsoleWindow : FancyWindow,
    IComputerWindow<ThetaShuttleConsoleBoundInterfaceState>
{
    ...
    public ModularRadarShuttleConsoleWindow()
    {
        ...
        NavContainer.StealthButtonPressed += () => StealthButtonPressed?.Invoke();
    }
    ...
    public void UpdateState(EntityUid owner, ThetaShuttleConsoleBoundInterfaceState cState)
    {
        ...
        NavContainer.SetMatrix(coordinates, cState.NavState.Angle);
    ...
    {
        NavContainer.SetStealthStatus(ready);
    }
}
