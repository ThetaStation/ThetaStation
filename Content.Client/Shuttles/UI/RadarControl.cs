...
public abstract class RadarControl : Control
{
    ...
    protected float _radarMinRange = SharedRadarConsoleSystem.DefaultMinRange;
    protected float _radarMaxRange = SharedRadarConsoleSystem.DefaultMaxRange;
    ...
    /// </summary>
    protected float _actualRadarRange = SharedRadarConsoleSystem.DefaultMinRange;
