    ...
    public sealed class MoverController : SharedMoverController
    {
        ...
        private void HandleShuttleMovement(float frameTime)
        {
            ...
            foreach (var (shuttleUid, (shuttle, pilots)) in _shuttlePilots)
            {
                ...
                MoveShuttle(frameTime, shuttleUid, shuttle, body, linearInput, angularInput, brakeInput, xformQuery);
            }
        }

        //moves the shuttle according to inputs
        public void MoveShuttle(
            float frameTime,
        ...
        {
            Angle shuttleNorthAngle = _xformSystem.GetWorldRotation(shuttleUid, xformQuery);
